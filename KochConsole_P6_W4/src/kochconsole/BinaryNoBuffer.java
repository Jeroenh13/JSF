 ...
 * @author jsf3
 */
public class BinaryNoBuffer implements Observer {
    ...
    public static void main(String[] args) {
        ...
        BinaryNoBuffer kConsole = new BinaryNoBuffer();
        kConsole.SaveToFile("/hddJeroen/kochFiles/BinaryNoBuffer");
